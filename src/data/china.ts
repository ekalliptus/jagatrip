export const chinaProgram = {
  ...
  founder: {
    ...
    points: [
      { icon: '🌍', text: 'Telah menjejakkan kaki di 30+ negara di Asia, Afrika & Eropa — bukan sekadar jalan-jalan, tapi membawa pulang ilmu nyata tentang sistem pendidikan dunia.' },
      { icon: '✈️', text: 'Menggagas program backpacker edukatif lintas negara — dari 2 negara hingga 30 negara dalam satu perjalanan. Belajar sambil menjelajah, bukan pilih salah satu.' },
      { icon: '👨‍🏫', text: 'Berpengalaman mendampingi kepala sekolah, guru & praktisi pendidikan dalam study visit ke institusi pendidikan mancanegara di Jepang, China, Korea, Taiwan, hingga Timur Tengah.' },
      { icon: '🔍', text: 'Aktif melakukan benchmarking langsung ke sekolah & kampus internasional di Asia Timur & Timur Tengah — riset lapangan yang jadi pondasi setiap program JAGATRIP.' },
      { icon: '🕌', text: 'Memiliki rekam jejak pendampingan program studi Islam internasional di Malaysia, Madinah & Cairo — menggabungkan wawasan global dengan nilai-nilai pendidikan Islam.' },
      { icon: '👥', text: 'Telah mengkoordinasikan puluhan peserta per program — pelajar, guru, hingga pengelola sekolah — dengan manajemen perjalanan yang terstruktur & tujuan pembelajaran yang jelas.' },
      { icon: '🎯', text: 'Setiap destinasi dipilih berdasarkan observasi & riset mendalam, bukan tren — sehingga setiap edutrip punya dampak nyata bagi pengembangan institusi pendidikan di Indonesia.' },
    ],
  },
